...
function TopBar({
  ...
  return (
    <header className="sticky top-0 z-[1200] border-b border-[#dce5dc] bg-[#f7f8f4]/95 px-4 py-3 shadow-[0_1px_0_rgba(13,40,28,0.03)] backdrop-blur">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <label className="relative min-w-[250px] flex-1">
          ...
          <input
            ...
            placeholder="Search by Flag ID, location or report"
        ...
        <div ref={notificationRef} className="relative">
          ...
          {isNotificationOpen ? (
            <div className="absolute right-0 z-[1220] mt-2 w-80 origin-top-right animate-[vr-pop-in_180ms_ease-out] rounded-xl border border-[#d9e2d9] bg-white p-3 shadow-panel">
              <p className="text-sm font-semibold text-[#173127]">Recent Notifications</p>
              <div className="vr-subtle-scrollbar mt-2 max-h-72 space-y-2 overflow-y-auto pr-1">
                {notifications.length ? (
                  ...
                  <p className="text-xs text-[#6f7c75]">No new notifications.</p>
                )}
              </div>
            </div>
          ) : null}
        ...
        <div ref={userMenuRef} className="relative">
          ...
          {isUserMenuOpen ? (
            <div className="absolute right-0 z-[1220] mt-2 w-64 origin-top-right animate-[vr-pop-in_180ms_ease-out] rounded-xl border border-[#d9e2d9] bg-white p-3 shadow-panel">
